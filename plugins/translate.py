...
async def start(client, message):
          ...
          await message.reply_text(text =f"Salam **{message.from_user.first_name }** 🤓 \n\n __Mən Dilmanc Bot'am \n İstədiyin mətni 100lərlə dilə tərcümə edə bilirəm__",reply_to_message_id = message.message_id , parse_mode="markdown", reply_markup=InlineKeyboardMarkup(            [                [                    InlineKeyboardButton("Sahibim 🤓" ,url="https://t.me/epicprojects") ],                 [InlineKeyboardButton("Support 🇦🇿", url="https://t.me/LuxeSup") ]           ]        ) )
