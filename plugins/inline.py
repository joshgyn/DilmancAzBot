...
async def inline(_, query: InlineQuery):
        ...
        if string == "":
        	METHOD=  [ InlineQueryResultArticle( title="İstifadə qaydası 📋", input_message_content=InputTextMessageContent("Məsələn ; ```@DilmancAzBot Tərcümə # en```"),description="{Mətn} # {Dil kodu} ",thumb_url="https://tg-link.herokuapp.com/dl/0/AgADh60xG50-wFc.jpg")]
